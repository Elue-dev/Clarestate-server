import { replyUserType } from "../models/types/email_types";

export const replyUser = ({ username, subject }: replyUserType) => {
  return `
                      ...
                      <td style="padding: 0 35px">
                        ...
                        <span style="text-align: left">
                          <p
                            ...
                            "
                          >
                            We recieved you email concerning '${subject}', and we will get back to you as soon as possible!
                          </p>
                          <br />
                        </span>
